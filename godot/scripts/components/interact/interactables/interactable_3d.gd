@icon("res://script/components/interaction/3D/grabbable.svg")
...
@export var outline_shader: Shader = preload("res://scripts/components/interact/visuals/pixel_perfect_outline.gdshader")
